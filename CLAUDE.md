...
Released to npm and mirrored as [GitHub Releases](https://github.com/antonygiomarxdev/citadel/releases). `CHANGELOG.md` is the source of truth; GitHub Release notes are extracted from it.
...
4. Add the link reference at the bottom: `[X.Y.Z]: https://github.com/antonygiomarxdev/citadel/releases/tag/vX.Y.Z`.
